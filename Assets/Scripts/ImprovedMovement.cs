...
public class ImprovedMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetAxis("Vertical") < 0 && !isDashing)
        {
            rb.velocity = new Vector2(rb.velocity.x * 0.6f, Mathf.Clamp(rb.velocity.y, terminalVelocity - 10, 1000));
        } else
        {
    ...
    private void WallJump()
    {
        ...
        StartCoroutine(DisableMovement(.135f));
